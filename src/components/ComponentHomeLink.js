    ...
    return(
          <>
            <div  className="d-flex flex-column mt-5 link" style={{color:"#929292",borderBottom:"2px solid #C9C9C9"}}>
                <motion.p whileHover={{scale:1.1, originX : 0}} transition={{type:"spring",stiffness : 600}} className="fw-bold"><img src={ProfileIcon} alt="Profile Icon" style={{width:"8%"}} className="mx-4"/>Profile</motion.p>
                <motion.p whileHover={{scale:1.1, originX : 0}} transition={{type:"spring",stiffness : 600}} className="mt-4 pb-4 fw-bold"><img src={BillIcon} alt="Bill Icon" style={{width:"8%"}} className="mx-4" />Subscribe</motion.p>
            </div>
